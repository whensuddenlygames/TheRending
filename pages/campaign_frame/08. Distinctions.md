...
## Reliquaries
Each landmass floating within the Abyssal Sea is called a Reliquary. Individually they are named after their respective Exemplar. To help distinguish the Reliquary from the Exemplar, mortals append the prefix Pala- to the name.
### A Silver Lining
...
### Astral Bridges
Only through the use of Astral Bridges, divine gates that rest on the edge of the Reliquaries, can a mortal travel from one location to another. These are rigid locations with specifically paired gates. The bridges are connected as such:

* Pala-Arbar is connected to Pala-Vivo, Pala-Iluz, Pala-Lum, and Pala-Graco.
* Pala-Graco is connected to Pala-Arbar and Pala-Lum
* Pala-Iluz is connected to Pala-Arbar and Pala-Scio
